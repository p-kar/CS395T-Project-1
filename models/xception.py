...
def xception(pretrained=False, target_type='regression', **kwargs):
    """
    Construct Xception.
    """

    model = Xception(mode='regression', **kwargs)
    if pretrained:
        pre_model = Xception(num_classes=1000)
        pre_model.load_state_dict(model_zoo.load_url(model_urls['xception']))
